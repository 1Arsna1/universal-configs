#!/bin/bash
sudo pacman -S --needed qemu-full qemu-img libvirt virt-install virt-manager virt-viewer edk2-ovmf dnsmasq swtpm guestfs-tools libosinfo dmidecode  ducker cockpit cockpit-files cockpit-machines cockpit-packagekit cockpit-podman cockpit-storaged wireguard-tools networkmanager-openvpn networkmanager openvpn openresolv podman podman-compose crun runc docker tuned 
